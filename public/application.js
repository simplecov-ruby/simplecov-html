...
$(document).ready(function() {
  ...
  // Add tabs based upon existing report_containers
  $('.report_container h2').each(function(){
    var container_id = $(this).parent().attr('id');
    var group_name = $(this).find('.group_name').first().html();

    $('.report_tabs').append('<li><a href="#' + container_id + '">' + group_name + '</a></li>');
  });
  ...
  $('.report_tabs a').each( function() {
    $(this).addClass($(this).attr('href').replace('#', ''));
  });

    // Make sure tabs don't get ugly focus borders when active
  $('.group_tabs a').live('focus', function() { $(this).blur(); });
  $('.report_tabs a').live('focus', function() { $(this).blur(); });
  ...
  $('.group_tabs a').live('click', function(){
    if (!$(this).parent().hasClass('active')) {
      ...
      $('.report_container').hide();
      $('.report_tabs a').parent().removeClass('active');
  ...
  $('.report_tabs a').live('click', function(){
    if (!$(this).parent().hasClass('active')) {
      $('.report_tabs a').parent().removeClass('active');
      $(this).parent().addClass('active');
